...
const palette={KICKS:"#ff5d5d",SNARES:"#ffd34e",CLAPS:"#ff9f43",HATS:"#5ad1c4",TOMS:"#c08bff",
  ...
  LOOPS:"#e0e060",KITS:"#5ad1c4",RECORDED:"#ff9f43",INCOMING:"#8b93a4"};
const _hc={};
...
let actx=null, auditionSrc=null, mapPts=[], analyzing=false, analyzeToken=0;

// ---- drum machine state ----
const NT=8, NS=16;
const FXDEF=()=>({vol:0.85,pan:0,cut:18000,q:0.8,low:0,high:0,pitch:0,mute:false});
const tracks=Array.from({length:NT},()=>({item:null,buffer:null,cat:null,fx:FXDEF(),nodes:null}));
